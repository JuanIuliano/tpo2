...
public class Grafo {
    ...
    public NodoCentroDistribucion devolverVerticecdd(int v){

        if(!existeVertice(v)){
            return null;
        }

        return (NodoCentroDistribucion) vertices.get(v);
    }
